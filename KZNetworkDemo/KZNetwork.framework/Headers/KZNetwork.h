...
//! Project version number for KZNetwork.
FOUNDATION_EXPORT double KZNetworkVersionNumber;

//! Project version string for KZNetwork.
FOUNDATION_EXPORT const unsigned char KZNetworkVersionString[];
